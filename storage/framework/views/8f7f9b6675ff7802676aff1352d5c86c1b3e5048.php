<?php $__env->startSection('pageTitle', 'onepage'); ?>
        ...
        <section class="index-project">
            ...
            <div class="index-project-tiles">
                <div class="index-project-tiles-item">
                    <img src="<?php echo e(asset("/images/ironman1.gif")); ?>" alt="">
                </div>
                <div class="index-project-tiles-item">
                    <img src="<?php echo e(asset("/images/ironman1.gif")); ?>" alt="">
                </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/rikvermeulen/Documents/websites/onepages3/resources/views/layout/index.blade.php ENDPATH**/ ?>